...
<fieldset>
    ...
    <acme:labelvalue code="curriculum.minSalaryExpectation" value="${curriculum.minSalaryExpectation}"
                     isCurrency="true"/>
    ...
    <jstl:if test="${curriculum.subSection.offer.inDevelopment && curriculum.subSection.commercial.id == actor.id}">
        <acme:button url="curriculum/edit.do?curriculumId=${curriculum.id}" text="curriculum.edit"
                     css="formButton toLeft"/>
    </jstl:if>
    <acme:button url="subSection/display.do?subSectionId=${curriculum.subSection.id}" text="curriculum.back"
                 css="formButton toLeft"/>
