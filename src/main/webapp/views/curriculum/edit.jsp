...
<form:form action="curriculum/edit.do" modelAttribute="curriculum">
    ...
    <acme:input type="number" code="curriculum.minSalaryExpectation" min="0.0" path="minSalaryExpectation"
                css="formInput"/>
    <br/>
    ...
    <acme:cancel url="subSection/display.do?subSectionId=${curriculum.subSection.id }" code="curriculum.cancel"
