...
<jstl:if test="${companyResult.tenderResult.tender.administrative.id == actor.id}">
    <acme:button url="companyResult/administrative/edit.do?companyResultId=${companyResult.id}"
                 text="companyResult.edit" css="formButton toLeft"/>
</jstl:if>
<acme:button url="tenderResult/display.do?tenderResultId=${companyResult.tenderResult.id}" text="companyResult.back"
