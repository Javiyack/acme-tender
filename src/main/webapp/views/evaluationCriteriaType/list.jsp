...
<display:table pagesize="5" class="displaytag" name="evaluationCriteriaTypes"
               requestURI="evaluationCriteriaType/administrative/list.do" id="row">
...
<br/>
<br/>
<acme:button url="/evaluationCriteriaType/administrative/create.do" text="evaluationCriteriaType.create"
