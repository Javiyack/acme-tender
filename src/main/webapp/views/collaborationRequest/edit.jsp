...
<form:form action="collaborationRequest/commercial/edit.do" modelAttribute="collaborationRequest">
    ...
    <jstl:if test="${collaborationRequest.id == 0 }">
        ...
        <acme:input type="number" code="collaborationRequest.benefitsPercentage" path="benefitsPercentage"
                    css="formInput"/>
        <br/>
        ...
        <acme:select code="collaborationRequest.commercial" itemLabel="userAccount.username" items="${commercials }"
                     path="commercial" id="id"/>
        <br/>
    </jstl:if>
    ...
    <jstl:choose>
        <jstl:when test="${collaborationRequest.id == 0}">
            <acme:cancel url="offer/display.do?offerId=${collaborationRequest.offer.id }"
