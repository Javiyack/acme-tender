...
<fieldset>
    ...
    <jstl:if test="${tenderResult.tender.administrative.id == actor.id}">
        <acme:button text="tenderResult.edit"
                     url="tenderResult/administrative/edit.do?tenderResultId=${tenderResult.id}"
...
<fieldset>
    ...
    <jstl:if test="${tenderResult.tender.administrative.id == actor.id}">
        <acme:button text="tenderResult.companyResult.create"
                     url="companyResult/administrative/create.do?tenderResultId=${tenderResult.id}"
                     css="formButton toLeft"/>
    </jstl:if>
