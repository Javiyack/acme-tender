...
<form:form action="evaluationCriteria/administrative/edit.do" modelAttribute="evaluationCriteria">
    ...
    <acme:select itemLabel="name" blankValue="false" items="${evaluationCriteriaTypes}" path="evaluationCriteriaType"
                 code="evaluationCriteria.evaluationCriteriaType" id="id"/>
    ...
    <acme:cancel url="/tender/display.do?tenderId=${tenderId}" code="evaluationCriteria.cancel"
