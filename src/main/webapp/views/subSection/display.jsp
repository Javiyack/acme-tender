...
<fieldset>
    ...
    <jstl:if test="${subSection.offer.inDevelopment && subSection.commercial.id == actorId}">
        <acme:button text="subSection.edit" url="/subSection/commercial/edit.do?subSectionId=${subSection.id}"
                     css="formButton toLeft"/>
    </jstl:if>
    <jstl:if test="${subSection.offer.inDevelopment && subSection.administrative.id == actorId}">
        <acme:button text="subSection.edit" url="/subSection/administrative/edit.do?subSectionId=${subSection.id}"
                     css="formButton toLeft"/>
    </jstl:if>
...
<jstl:if test="${subSection.section != 'ADMINISTRATIVE_ACREDITATION'}">
    <fieldset>
        ...
        <jstl:if test="${subSection.offer.inDevelopment && subSection.commercial.id == actorId}">
            <acme:button text="curriculum.create" url="/curriculum/create.do?subSectionId=${subSection.id}"
                         css="formButton toLeft"/>
        </jstl:if>
    </fieldset>
</jstl:if>
...
<jstl:if
        test="${subSection.offer.inDevelopment && (subSection.commercial.id == actorId || subSection.administrative.id == actorId)}">
...
<jstl:if test="${subSection.section != 'ADMINISTRATIVE_ACREDITATION'}">
    <fieldset>
        ...
        <jstl:if
                test="${subSection.offer.inDevelopment && subSection.commercial.id == actorId && tenderHasEvaluationCriterias}">
            <acme:button text="subSectionEvaluationCriteria.create"
                         url="/subSectionEvaluationCriteria/commercial/create.do?subSectionId=${subSection.id}"
                         css="formButton toLeft"/>
        </jstl:if>
        <jstl:if
                test="${subSection.offer.inDevelopment && subSection.commercial.id == actorId && !tenderHasEvaluationCriterias}">
