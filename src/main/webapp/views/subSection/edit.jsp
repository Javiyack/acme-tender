...
<form:form action="${requestURI}" modelAttribute="subSection" method="post">
    ...
    <jstl:if
            test="${subSection.commercial.id == actorId && subSection.id != 0 && subSection.offer.commercial.id == actorId}">
        <acme:submit name="delete" code="subSection.delete" css="formButton toLeft"/>
    </jstl:if>

    <acme:cancel url="offer/display.do?offerId=${subSection.offer.id}" code="subSection.cancel"
