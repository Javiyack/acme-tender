...
<div class="center">
    ...
    <div style="float: right; margin-right: 50px; vertical-align: middle; height: 100%; margin-top: 5px;">
        ...
        <a href="?language=es"><img src="images/spain.ico" class="iconoenlace" style="margin-bottom: 5px;"
                                    title="Cambiar a español"/></a>
        <a href="?language=en"><img src="images/uk.ico" class="iconoenlace" style="margin-bottom: 5px;"
                                    title="Change to english"/></a>
    </div>
</div>