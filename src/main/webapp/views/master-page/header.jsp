    ...
    <security:authorize access="hasRole('ADMINISTRATIVE')">
        <div class="dropdown" style="float: left">
            ...
            <div class="dropdown-content">
                ...
                <b><a href="evaluationCriteriaType/administrative/list.do"><spring:message
                        code="master.page.evaluation.criteria.types"/></a></b>
                <hr/>
    ...
    <security:authorize access="hasRole('ADMIN')">
        <div class="dropdown" style="float: left">
            ...
            <div class="dropdown-content">
                ...
                <b><a href="category/administrator/list.do"><spring:message
                        code="master.page.tender.categories"/></a></b>
                <hr/>
