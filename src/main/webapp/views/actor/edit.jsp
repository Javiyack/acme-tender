        ...
        <jstl:if test="${edition}">
            <div class="seccion">
                ...
                <jstl:if test="${creation}">
                    ...
                    <br/>
                    <acme:password code="profile.userAccount.password" path="password" css="formInput" id="password"
                                   onkeyup="javascript: checkPassword();"/>
                    <br/>
                    <acme:password code="profile.userAccount.repeatPassword" path="confirmPassword"
                                   id="confirm_password" css="formInput" onkeyup="javascript: checkPassword();"/>
                    <br>
                </jstl:if>
                <jstl:if test="${!creation}">
                    <legend>
                    ...
                    <div id="changePassword" style="display:none;">
                        ...
                        <acme:textbox code="actor.username" path="username" css="formInput"/>
                        <br/>
                        <acme:password code="profile.userAccount.oldPassword" path="password" css="formInput"
                                       id="password" onkeyup="javascript: checkEdition();"/>
                        <br/>
                        <acme:password code="profile.userAccount.newPassword" path="newPassword" css="formInput"
                                       id="new_password" onkeyup="javascript: checkEdition();"/>
                        <br/>
                        <acme:password code="profile.userAccount.repeatPassword" path="confirmPassword"
                                       id="confirm_password" css="formInput" onkeyup="javascript: checkEdition();"/>
                        <br/>
                    </div>
                </jstl:if>
            </div>
